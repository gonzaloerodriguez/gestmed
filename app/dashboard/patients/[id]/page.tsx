...
export default function PatientDetailPage({ params }: PatientDetailPageProps) {
  ...
  const loadPatientData = async () => {
    ...
    try {
      ...
      // Cargar historia clínica activa
  ...
  const handlePatientUpdated = () => {
    // Si el paciente fue archivado, redirigir a la lista
    router.push("/dashboard/patients");
  };
    ...
    <div className="container mx-auto py-8">
      ...
      <div className="flex items-center justify-between mb-8 mx-4">
        <div>
          ...
          <p className="text-gray-600">Historia Clínica</p>
        </div>
...
//       // Cargar TODAS las prescripciones del paciente
//       const { data: prescriptionsData, error: prescriptionsError } =
//         await supabase
//           .from("prescriptions")
//           .select("*")
...
//   const handlePatientUpdated = () => {
//     // Si el paciente fue eliminado, redirigir a la lista
//     router.push("/dashboard/patients");
//   };
