...
export default function PatientsPage() {
  ...
  const loadDoctor = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Error al cargar información del doctor",
        variant: "destructive",
      });
      router.push("/login");
    } finally {
  ...
  const loadArchivedCount = async () => {
    ...
    try {
      ...
      console.error("Error loading archived count:", error.message);
    }
  };
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between">
            <div>
              <CardTitle>Lista de Pacientes Activos</CardTitle>
              <CardDescription>
                {filteredPatients.length} paciente
                {filteredPatients.length !== 1 ? "s" : ""} activo
