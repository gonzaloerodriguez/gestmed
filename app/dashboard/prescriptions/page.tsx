...
import { ArrowLeft, Plus, Search, MoreVertical, Eye, Edit, Trash2, FileText, Calendar, User } from "lucide-react"
...
export default function PrescriptionsPage() {
    ...
    if (searchTerm.trim() === "") {
      ...
      const filtered = prescriptions.filter(
        (prescription) =>
          ...
          prescription.patient_cedula?.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const handleDeletePrescription = async () => {
    ...
    try {
      const { error } = await supabase.from("prescriptions").update({ is_active: false }).eq("id", prescriptionToDelete)
          ...
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600">Gestiona todas tus recetas médicas</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {new Set(prescriptions.map((p) => p.patient_name.toLowerCase())).size}
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Busca por nombre del paciente, cédula, diagnóstico o medicamentos</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            {filteredPrescriptions.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  {prescriptions.length === 0 ? "No hay recetas creadas" : "No se encontraron recetas"}
                </h3>
                      ...
                      <TableRow key={prescription.id}>
                        <TableCell>
                          <div>
                            ...
                            {prescription.patient_cedula && (
                              <div className="text-sm text-gray-500">CI: {prescription.patient_cedula}</div>
                            )}
                        ...
                        <TableCell>
                          <div className="max-w-xs">
                            <div className="truncate">{prescription.diagnosis || "Sin diagnóstico"}</div>
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem
                                ...
                                onClick={() => openDeleteDialog(prescription.id)}
                              >
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción no se puede deshacer. La receta será marcada como inactiva y no aparecerá en la lista.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
