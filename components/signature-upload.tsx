...
//   const [saving, setSaving] = useState(false);
//   const [error, setError] = useState<string | null>(null);
//   const [previewSize, setPreviewSize] = useState(150); // Tamaño de vista previa en píxeles
...
//       // Validar tamaño (5MB máximo para la subida inicial)
//       if (file.size > 500 * 1024) {
//         setError("La imagen es demasiado grande (máximo 500KB)");
//         setSignatureFile(null);
//         return;
...
//       {signaturePreview && (
//         <div className="border rounded-lg p-4 bg-gray-50">
//           <p className="text-sm text-gray-600 mb-2">Firma y sello actual:</p>
//           <div className="flex flex-col items-center">
//             <div className="bg-white p-4 border rounded mb-2">
//               <img
//                 src={signaturePreview || "/placeholder.svg"}
...
//             <div className="w-full max-w-xs">
//               <Label htmlFor="size-range" className="text-xs text-gray-500">
//                 Ajustar tamaño de vista previa:
//               </Label>
//               <div className="flex items-center space-x-2">
//                 <ZoomOut className="h-4 w-4 text-gray-500" />
//                 <input
...
//                 Nota: Este ajuste es solo para la vista previa. La firma se
//                 optimizará automáticamente para los documentos.
//               </p>
//             </div>
//           </div>
//         </div>
...
//               fondo
//             </li>
//             <li>Mantén la cámara paralela al papel para evitar distorsiones</li>
//             <li>
//               La imagen será optimizada automáticamente (400x200px máximo)
//             </li>
//             <li>Tamaño máximo de archivo: 5MB (resultado final: ~300KB)</li>
//           </ul>
//         </div>
...
export function SignatureUpload({
  ...
  const handleFileChange = (file: File | null) => {
    ...
    if (file) {
      ...
      // Validar tamaño (2MB máximo para la subida inicial)
    ...
    <div className="space-y-6">
      ...
      <div>
        <Label htmlFor="signature_stamp">
          Nueva Firma y Sello (PNG recomendado)
        </Label>
        <Input
          id="signature_stamp"
          type="file"
        ...
        />
        <p className="text-xs text-gray-500 mt-1">
          Recomendación: Usa una imagen PNG con fondo transparente que incluya
          tanto tu firma como tu sello médico. Tamaño máximo: 500KB después de
          optimización.
        </p>
